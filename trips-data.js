/* ============================================================
   ...
   order        : 여행 순서 번호 (상세페이지 주소의 ?id= 값으로도 사용됩니다, 날짜순으로 매겨주세요)
   dateLabel    : 화면에 보일 날짜 (예: "2023.07.03")
   title        : 여행지 이름
   country      : 나라 이름 (생일 사진처럼 나라가 없는 항목은 빈 문자열로 두면 됩니다)
   type         : "trip"(여행) 또는 "birthday"(생일 사진). 안 적으면 자동으로 "trip"으로 처리됩니다.
                  헤더의 "○번의 여행 · ○개국" 통계는 type이 "trip"인 항목만 셉니다.
   tone         : 사진 영역 색상 - "coral"/"sage"/"butter"/"sky"/"blossom" 중 선택
   icon         : 사진 영역 아이콘 - "plane"/"sun"/"wave"/"mountain"/"cake" 중 선택
   note         : 카드에 보일 한 줄 메모
   ...
   lat, lng     : 여행 지도에 찍힐 좌표 (구글맵에서 위치 검색 후 우클릭하면 좌표 나옵니다)
   mapPoints    : 여러 도시를 도는 여행이면 [{ name, lat, lng }, ...] 형태로 여러 핀 추가
                  (mapPoints가 있으면 lat/lng 대신 이걸 사용합니다)
============================================================= */
...
const TONES = {
  ...
  sky:    ["#7CA6C7", "#B7D2E4"],
  blossom:["#D98BA7", "#F0C4D6"]
};

const TAPE_COLORS = { coral:"#E2795F", sage:"#8FA681", butter:"#E7BE5C", sky:"#7CA6C7", blossom:"#D98BA7" };
...
const ICONS = {
  ...
  cake: `<svg viewBox="0 0 24 24"><path d="M4 21v-8a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8Z"/><path d="M4 17h16"/><path d="M8 11V7M12 11V7M16 11V7"/><path d="M8 7c0-1 1-1 1-2s-1-1-1-2"/><path d="M12 7c0-1 1-1 1-2s-1-1-1-2"/><path d="M16 7c0-1 1-1 1-2s-1-1-1-2"/></svg>`
};
...
const TRIPS = [
  {
    order:1, dateLabel:"2022.07.19", title:"지아 생일 사진", country:"",
    type:"birthday",
    tone:"blossom", icon:"cake",
    note:"",
    companions:"",
    photoUrl:"", detailUrl:"",
    coverImage:"images/birthday-01.jpg",
    itinerary:[],
    accommodations:[],
    flights:[],
    documents:[]
  ...
  {
    order:2, dateLabel:"2023.07.03", title:"다낭", country:"베트남",
    type:"trip",
    tone:"coral", icon:"sun",
    note:"우리 가족 첫 해외여행",
    companions:"아빠(김요한), 엄마(김시은), 할머니(남연순), 지아",
    photoUrl:"https://photos.app.goo.gl/SzEc7EuL3hSRJr3W8", detailUrl:"",
  ...
  {
    order:3, dateLabel:"2023.07.19", title:"지아 생일 사진", country:"",
    type:"birthday",
    tone:"blossom", icon:"cake",
    note:"",
    companions:"",
    photoUrl:"", detailUrl:"",
    coverImage:"images/birthday-02.jpg",
    itinerary:[],
    accommodations:[],
    flights:[],
    documents:[]
  ...
  {
    order:4, dateLabel:"2023.09.10", title:"후쿠오카", country:"일본",
    type:"trip",
    tone:"sky", icon:"wave",
    note:"",
    companions:"",
    photoUrl:"https://photos.app.goo.gl/WBATXxH9gE3XVaS18", detailUrl:"",
  ...
  {
    order:5, dateLabel:"2024.05.12", title:"나트랑", country:"베트남",
    type:"trip",
    tone:"coral", icon:"wave",
    note:"",
    companions:"김해팀 - 아빠(김요한)·엄마(김시은), 인천팀 - 인천할아버지(김호식)·인천할머니(남연순)·이모(김재은)",
    photoUrl:"https://photos.app.goo.gl/JWpcWmhi34vdx7mbA", detailUrl:"",
  ...
  {
    order:6, dateLabel:"2024.07.19", title:"지아 생일 사진", country:"",
    type:"birthday",
    tone:"blossom", icon:"cake",
    note:"",
    companions:"",
    photoUrl:"", detailUrl:"",
    coverImage:"images/birthday-03.jpg",
    itinerary:[],
    accommodations:[],
    flights:[],
    documents:[]
  ...
  {
    order:7, dateLabel:"2024.11.20", title:"덴버 · 샌디에고 · 로스앤젤레스 · 샌프란시스코", country:"미국",
    type:"trip",
    tone:"butter", icon:"mountain",
    note:"미국 시민권자 지아가 태어나서 처음 밟아본 미국 땅",
    companions:"",
    photoUrl:"https://photos.app.goo.gl/wJW6aUSeKXhL3QhY9", detailUrl:"",
    coverImage:"images/usa-01.jpg",
    mapPoints:[
      { name:"덴버", lat:39.7392, lng:-104.9903 },
      { name:"샌디에고", lat:32.7157, lng:-117.1611 },
  ...
  {
    order:8, dateLabel:"2025.07.07", title:"오키나와", country:"일본",
    type:"trip",
    tone:"sky", icon:"sun",
    note:"",
    companions:"",
    photoUrl:"https://photos.app.goo.gl/XM8GtZC52mJyHasb9", detailUrl:"",
  ...
  {
    order:9, dateLabel:"2025.07.19", title:"지아 생일 사진", country:"",
    type:"birthday",
    tone:"blossom", icon:"cake",
    note:"",
    companions:"",
    photoUrl:"", detailUrl:"",
    coverImage:"images/birthday-04.jpg",
    itinerary:[],
    accommodations:[],
    flights:[],
    documents:[]
  ...
  {
    order:10, dateLabel:"2026.06.22", title:"후쿠오카 · 나가사키 · 기타큐슈", country:"일본",
    type:"trip",
    tone:"sage", icon:"mountain",
    note:"",
    companions:"아빠(김요한), 엄마(김시은), 할머니(남연순), 지아",
    photoUrl:"https://photos.app.goo.gl/m2z69eCoEz6hTT7p9",
    detailUrl:"https://kurios0526.github.io/kyushu-trip/",
    coverImage:"images/kyushu-01.jpg",
    mapPoints:[
      { name:"후쿠오카", lat:33.5904, lng:130.4017 },
      { name:"나가사키", lat:32.7503, lng:129.8779 },
      { name:"기타큐슈(고쿠라)", lat:33.8834, lng:130.8751 }
    ],
    itinerary:[
  ...
  {
    order:11, dateLabel:"2026.07.19", title:"지아 생일 사진", country:"",
    type:"birthday",
    tone:"blossom", icon:"cake",
    note:"",
    companions:"",
    photoUrl:"", detailUrl:"",
    coverImage:"images/birthday-05.jpg",
    itinerary:[],
    accommodations:[],
    flights:[],
    documents:[]
